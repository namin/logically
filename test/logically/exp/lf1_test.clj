...
(deftest test-naturals
  ...
  (is (= (run* [q] (fresh [a b c] (== q [c a b]) (naturals-clauses c a b)))
         '([(nat) typ []]
           ...
           [(sum-inc-s _0 _1 _2 _3 _4 _5)
            (sum-inc _0 _1 _2 (plus-s _0 _1 _2 _3) (plus-s _0 (s _1) (s _2) _4))
  ...
  (is (= (run* [q] (fresh [a b d n n1 n2 n3] (naturals a (plus (z) n n)) (naturals d (sum-inc n1 n2 n3 a b)) (naturals b q)))
         '((plus (z) (s _0) (s _0)))))
  (is (= (run 2 [q] (fresh [a b d n1 n2 n3] (naturals d (sum-inc n1 n2 n3 a b)) (naturals b q)))
         ;; NOTE: going to 3 hangs now :(
         '((plus (z) (s _0) (s _0)) (plus (s (z)) (s (z)) (s (s (z)))))))
